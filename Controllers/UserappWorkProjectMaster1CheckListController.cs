...
namespace getbiz_work_project_management.Controllers
{
   // [Route("api/[controller]")]
    ...
    public class UserappWorkProjectMaster1CheckListController : ControllerBase
    {
        ...
        public IActionResult DeleteUserappWorkProjectMaster1CheckList(string Id,Int64 Check_List_S_No)
        {
            try
            {
                var messages = _userappWorkProjectMaster1CheckListRepository.DeleteUserappWorkProjectMaster1CheckList(Id,Check_List_S_No);
                if (messages == null)
                {
                    return NotFound();
                }
