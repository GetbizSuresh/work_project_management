...
namespace getbiz_work_project_management.Getbiz_DbContext
{
    public class GetSetDatabase
    {
      ...
      //  private List<completed_projects_list> test;
        ...
        public Response UpdateUserappWorkProjectMaster1(userapp_work_project_master1 obj_userapp_work_project_master1)
        {
            ...
            try
            {
                ...
                using MySqlConnection con = new MySqlConnection(connection);
                {
                    ...
                    param[5] = new MySqlParameter("p_progress", MySqlDbType.Int64);
                    param[5].Value = obj_userapp_work_project_master1.progress;
        ...
        public DataTable GetTasksByResourceId(string Resource_Id, string Task_Id)
        {
            {
                Response response = new Response();
                DataTable ds = new DataTable();
        ...
        public Response DeleteUserappWorkProjectMaster1CheckList(string Id, Int64 Check_List_S_No)
        {
            Response response = new Response();
            DataSet ds = new DataSet();
            ...
            try
            {
                ...
                using MySqlConnection con = new MySqlConnection(connection);
                {
                    ...
                    param[1] = new MySqlParameter("p_Check_List_S_No", MySqlDbType.Int64);
